 ...
 * works, which is a different claim and the one a judge is actually owed.
 *
 * Three properties it is built to hold on a stage:
 *
...
/** Dial the whole demo up or down on stage: PARALLAX_PACE=1.6 bun run demo:live */
