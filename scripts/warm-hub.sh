...
# warm. Run this within ten minutes of presenting, and again while the team
# before you is on stage.
#
...
if [ "${1:-}" = "--watch" ]; then
  # Keep it awake through the presentations. Well inside the 15-minute window.
