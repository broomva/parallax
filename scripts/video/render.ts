...
const SCALE = arg("--scale", 0.75); // 1920x1080 -> 1440x810, plenty for a projector
const WIDTH = 1920;
const HEIGHT = 1080;
...
// ---------------------------------------------------------------- encode
// docs/, not out/: out/ is gitignored, so a backup video written there exists
// on exactly one laptop. That is the same mistake that shipped a landing page
// whose every asset 404ed -- see .gitignore.
const outPath = join(ROOT, "docs", "backup-demo.mp4");
